...
"""Centraliza a colagem das pastas em assets em uma única função"""
"""Junta o nome da pasta de assets com o arquivo desejado de forma nativa."""
def montar_caminho(pasta, arquivo):
    return join('assets', pasta, arquivo)
